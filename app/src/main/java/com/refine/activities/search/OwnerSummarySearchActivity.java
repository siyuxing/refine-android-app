...
public class OwnerSummarySearchActivity extends CommonActivity {
    private static final String OWNER_PLACE_HOLDER_OPTION = "请选择";
    private static final String PRODUCT_PLACE_HOLDER_OPTION = "全部";
    ...
    private List<String> allUsers = Lists.newArrayList(OWNER_PLACE_HOLDER_OPTION);
    private List<String> allProducts = Lists.newArrayList(PRODUCT_PLACE_HOLDER_OPTION);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startDateET.setOnClickListener(v -> new DatePickerDialog(OwnerSummarySearchActivity.this, startDateSetListener,
                                                                 myCalendar.get(Calendar.YEAR),
                                                                 myCalendar.get(Calendar.MONTH),
                                                                 myCalendar.get(Calendar.DAY_OF_MONTH)).show());

        endDateET.setOnClickListener(v -> new DatePickerDialog(OwnerSummarySearchActivity.this, endDateSetListener,
                                                               myCalendar.get(Calendar.YEAR),
                                                               myCalendar.get(Calendar.MONTH),
                                                               myCalendar.get(Calendar.DAY_OF_MONTH)).show());
    }
    ...
    protected void onStart() {
        ...
        try {
            allUsers = Lists.newArrayList(OWNER_PLACE_HOLDER_OPTION);
            ...
            allProducts = Lists.newArrayList(PRODUCT_PLACE_HOLDER_OPTION);
    ...
    public void search(View v) {
        if (OWNER_PLACE_HOLDER_OPTION.equals(allUsers.get(ownerSpinner.getSelectedItemPosition()))) {
            errorPopUp("请选择用户");
            return;
        }
        ...
        Thread background = new Thread() {
            public void run() {
                Intent intent = new Intent(OwnerSummarySearchActivity.this, OwnerSummaryDetailsActivity.class);
                ...
                if (productSpinner.getSelectedItemPosition() != AdapterView.INVALID_POSITION
                            && !PRODUCT_PLACE_HOLDER_OPTION.equals(allProducts.get(productSpinner.getSelectedItemPosition()))) {
